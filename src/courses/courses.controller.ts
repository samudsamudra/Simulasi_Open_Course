    ...
    async createCourse(
        ...
        throw new BadRequestException('Harga course harus berupa angka positif atau nol.');
        }
        return this.coursesService.createCourse(title, description, category, priceValue);
    }
    ...
    async updateCourse(
        ...
        return this.coursesService.updateCourse(courseId, title, description, category, priceValue);
    }
